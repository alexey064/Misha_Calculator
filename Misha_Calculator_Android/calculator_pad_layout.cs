...
//данный класс может пригодится. В одном из проектов он используется для вызова расширенных функций(sin, cos, log)
//данный класс предстоит изучить, а пока будет весь закомментирован.
/*
namespace Misha_Calculator_Android
{
    class calculator_pad_layout
    {
